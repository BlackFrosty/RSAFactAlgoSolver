...
import RSA.model.ModelObserver;

@SuppressWarnings("serial") 
public class RSAEditor extends JFrame implements ModelObserver {
	
	private RSAModel maze;
	
	private final RSAPersistenceManager persistenceManager;
